#!/usr/bin/env python3
"""
This script filters personal information (PII) from log messages using regular expressions and environmental variables.
...
         separator: str) -> str:
  """
  Filters a log message by replacing occurrences of PII fields with a redaction string.
  """
  for item in fields:
